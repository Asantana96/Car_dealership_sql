...
ALTER TABLE
    "sales_rep" ADD PRIMARY KEY("sales_rep_id");
...
ALTER TABLE
    "customer" ADD CONSTRAINT "customer_sales_rep_id_foreign" FOREIGN KEY("sales_rep_id") REFERENCES "sales_rep"("sales_rep_id");
ALTER TABLE
...
ALTER TABLE
    "car" ADD CONSTRAINT "car_sales_id_foreign" FOREIGN KEY("sales_id") REFERENCES "sales_rep"("sales_rep_id");
ALTER TABLE
